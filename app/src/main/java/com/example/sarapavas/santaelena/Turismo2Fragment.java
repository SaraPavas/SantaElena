...
public class Turismo2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_turismo2, container, false);
        ...
        LatLng magica = new LatLng(6.280908, -75.502043);
        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(magica, 16);
        map.addMarker(new MarkerOptions().position(magica).title("Parque Arví").snippet("Sitios Turisticos"));
