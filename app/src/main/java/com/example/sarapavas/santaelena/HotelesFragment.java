...
public class HotelesFragment extends Fragment {
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0: return new Hoteles1Fragment();
                case 1: return new Hoteles2Fragment();
                case 2: return new Hoteles3Fragment();
            }
            return null;
        }
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(R.string.tiMagica);
                case 1:
                    return getString(R.string.tiMahuampa);
                case 2:
                    return getString(R.string.tiPpiedasblancas);
            }
            return null;
        }
    }
